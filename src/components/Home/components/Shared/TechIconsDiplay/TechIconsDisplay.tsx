...
function TechIconsDisplay(props: ITechIconsDisplay.TechIconsDisplayProps): JSX.Element {
  ...
  function generateTechIcons(icons: string[]): ReactFragment {
    return icons.map((icon: string) => createTechIcon(icon));
  }
